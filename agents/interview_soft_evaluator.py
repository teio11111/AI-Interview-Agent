...
## 评分量表（严格遵循，严禁虚高）
- **9-10 分**：远超岗位要求，业内顶尖水平（如思路严谨、逻辑清晰、表达流畅）
- **7-8 分**：明显高于平均水平，**对应综合分 80+**
- **5-6 分**：接近平均水平，**对应综合分 60-75**
- **3-4 分**：低于岗位基本要求，**对应综合分 40-55**
- **1-2 分**：明显不合格（如答非所问、表述混乱），**对应综合分 0-35**

**给分原则**：
- 若候选人回答混乱、答非所问、不愿承认不知道，**该维度不应超过 4 分**
- 不要因为"客气"而给出 6-7 分作为默认；5 分才是"普通水平"的真实反映
- "性格内向但表达清晰有条理"可给 6-7 分；"表述不清、逻辑混乱"最多 3-4 分
